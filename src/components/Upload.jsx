...
//         setLoading(true);
//         try {
//             const result = await axios.get("https://backend-for-pdf-uploader-ai-appliaction-2.onrender.com/get-files");
...
//                 "https://backend-for-pdf-uploader-ai-appliaction-2.onrender.com/upload-files",
//                 formData,
//                 {
...
//     const showPdf = (pdf) => {
//         setPdfFile(`https://backend-for-pdf-uploader-ai-appliaction-2.onrender.com/files/${pdf}`);
//     };
...
//                 `https://backend-for-pdf-uploader-ai-appliaction-2.onrender.com/update-title/${id}`,
//                 { title: newTitle }
//             );
//             if (result.data.status === "ok") {
...
//                 `https://backend-for-pdf-uploader-ai-appliaction-2.onrender.com/delete-file/${id}`
//             );
//             if (result.data.status === "ok") {
...
import { pdfjs } from "react-pdf";
import PdfComp from "../PdfComp";
// const https://backend-for-pdf-uploader-ai-appliaction-2.onrender.com = import.meta.env.VITE_NEXT_PUBLIC_BACKEND_ROUTE;
